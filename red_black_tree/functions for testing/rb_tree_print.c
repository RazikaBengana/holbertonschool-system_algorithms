...
/**
 * rb_print_t - program that stores recursively each level in an array of strings
 *
...
/**
 * rb_height - program that measures the height of a binary tree
 *
...
/**
 * rb_tree_print - program that prints a red-black tree
 *
